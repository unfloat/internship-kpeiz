...
<div class="panel panel-white">
    <div class="panel-body">
        ...
        <!-- </div>
        <div class="panel-body"> -->
            <a title="Choisir une chaine" data-toggle="modal" data-target="#savedPlaylistModal" class="right-sidebar-toggle" data-sidebar-id="main-right-sidebar"><button type="button" class="btn btn-default"><i class="fa fa-youtube-play"><span class="span"> Playlist Filter</span></i></button></a>
